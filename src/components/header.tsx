  ...
  return (
    <>
      <div
        ...
        className={`fixed inset-0 z-9998 bg-black/10 backdrop-blur-sm transition-all duration-700 ease-[cubic-bezier(0.76,0,0.24,1)] ${
          isExpanded
      ...
      >
        <div className="flex h-16 w-full shrink-0 items-center justify-between md:h-20">
          ...
          >
            <span
              className={`block h-0.75 w-6 bg-black transition-transform duration-300 ease-in-out ${
                isExpanded ? 'translate-y-2.25 rotate-45' : ''
              }`}
            />
            <span
              className={`block h-0.75 w-6 bg-black transition-opacity duration-300 ease-in-out ${

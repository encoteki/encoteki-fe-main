...
function CardItem({ data }: { data: Partial<(typeof cards)[0]> }) {
  return (
    <div
      className={`relative flex h-75 w-70 shrink-0 flex-col justify-between rounded-4xl border-3 border-black p-6 shadow transition-all duration-300 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-2 sm:h-87.5 sm:w-[320px] sm:p-7 md:h-100 md:w-90 md:p-8 xl:h-112.5 xl:w-100 ${data.color} `}
    >
      <div>

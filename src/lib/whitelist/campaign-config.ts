...
// A function, not a module-scope constant — reading env.* at import time
// would require CAMPAIGN_TARGET_ACCOUNT_USERNAME and friends to exist
// during `next build` itself, since Next's build-time page-data collection
// imports every route module just to inspect its config. Callers read this
